...
const CREATIVE_SVG = `<svg viewBox="0 0 480 600" style="height: 100%; width: auto; overflow: visible; animation: driftL 13s ease-in-out infinite alternate;"><g style="animation: svgsway 11s ease-in-out infinite alternate;"><path d="M 30 -20 C 70 120, 2 240, 50 360 C 86 470, 14 540, 50 620" pathLength="1" fill="none" stroke="#b5b890" stroke-width="1.4" stroke-linecap="round" opacity="0.95" style="stroke-dasharray: 0.82 0.18; animation: svgflow 18.0s linear infinite;"></path><path d="M 54 -20 C 104 120, 19 240, 79 360 C 124 470, 34 540, 74 620" pathLength="1" fill="none" stroke="#9da767" stroke-width="1.3" stroke-linecap="round" opacity="0.86" style="stroke-dasharray: 0.82 0.18; animation: svgflow 21.5s linear infinite reverse;"></path><path d="M 78 -20 C 138 120, 36 240, 108 360 C 162 470, 54 540, 98 620" pathLength="1" fill="none" stroke="#848945" stroke-width="1.2" stroke-linecap="round" opacity="0.77" style="stroke-dasharray: 0.82 0.18; animation: svgflow 25.0s linear infinite;"></path><path d="M 102 -20 C 172 120, 53 240, 137 360 C 200 470, 74 540, 122 620" pathLength="1" fill="none" stroke="#6d7238" stroke-width="1.1" stroke-linecap="round" opacity="0.68" style="stroke-dasharray: 0.82 0.18; animation: svgflow 28.5s linear infinite reverse;"></path><path d="M 126 -20 C 206 120, 70 240, 166 360 C 238 470, 94 540, 146 620" pathLength="1" fill="none" stroke="#a3a878" stroke-width="1.0" stroke-linecap="round" opacity="0.59" style="stroke-dasharray: 0.82 0.18; animation: svgflow 32.0s linear infinite;"></path><path d="M 150 -20 C 240 120, 87 240, 195 360 C 276 470, 114 540, 170 620" pathLength="1" fill="none" stroke="#b5b890" stroke-width="0.9" stroke-linecap="round" opacity="0.50" style="stroke-dasharray: 0.82 0.18; animation: svgflow 35.5s linear infinite reverse;"></path><path d="M 174 -20 C 274 120, 104 240, 224 360 C 314 470, 134 540, 194 620" pathLength="1" fill="none" stroke="#9da767" stroke-width="0.7" stroke-linecap="round" opacity="0.41" style="stroke-dasharray: 0.82 0.18; animation: svgflow 39.0s linear infinite;"></path><path d="M 198 -20 C 308 120, 121 240, 253 360 C 352 470, 154 540, 218 620" pathLength="1" fill="none" stroke="#848945" stroke-width="0.6" stroke-linecap="round" opacity="0.32" style="stroke-dasharray: 0.82 0.18; animation: svgflow 42.5s linear infinite reverse;"></path></g><circle cx="184" cy="238" r="2.6" fill="#9da767" style="animation: svgpulse 7.3s ease-in-out 4.1s infinite;"></circle><circle cx="218" cy="406" r="1.1" fill="#6d7238" style="animation: svgpulse 9.9s ease-in-out 2.1s infinite;"></circle><circle cx="219" cy="88" r="2.5" fill="#6d7238" style="animation: svgpulse 5.1s ease-in-out 5.7s infinite;"></circle><circle cx="137" cy="513" r="2.6" fill="#848945" style="animation: svgpulse 6.7s ease-in-out 3.5s infinite;"></circle><circle cx="177" cy="322" r="2.0" fill="#9da767" style="animation: svgpulse 6.2s ease-in-out 4.5s infinite;"></circle><circle cx="140" cy="127" r="1.0" fill="#b5b890" style="animation: svgpulse 10.2s ease-in-out 5.1s infinite;"></circle><circle cx="98" cy="81" r="1.0" fill="#6d7238" style="animation: svgpulse 8.0s ease-in-out 1.7s infinite;"></circle><circle cx="102" cy="69" r="1.9" fill="#9da767" style="animation: svgpulse 5.4s ease-in-out 1.0s infinite;"></circle><circle cx="173" cy="208" r="2.8" fill="#6d7238" style="animation: svgpulse 10.1s ease-in-out 5.4s infinite;"></circle><circle cx="153" cy="54" r="1.6" fill="#b5b890" style="animation: svgpulse 5.7s ease-in-out 0.3s infinite;"></circle><circle cx="125" cy="101" r="2.8" fill="#9da767" style="animation: svgpulse 8.0s ease-in-out 3.8s infinite;"></circle><circle cx="113" cy="45" r="1.0" fill="#848945" style="animation: svgpulse 5.8s ease-in-out 4.0s infinite;"></circle></svg>`;
